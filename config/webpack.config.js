...
const WebpackHtmlCdnPlugin = require("./plugins/cdn2Html");
...
module.exports = function (webpackEnv) {
  ...
  const ifAnalyzing = process.argv.includes('--analyze');
  ...
  const getStyleLoaders = (cssOptions, preProcessor) => {
    const designSize = !!appPackage.designSize;
    ...
    const loaders = [
      ...
      designSize && {
        ...
        options: {
          remUnit: appPackage.designSize / 10
        },
      },
      {
  ...
  return {
    ...
    plugins: [
      ...
      ifAnalyzing && new BundleAnalyzerPlugin(),
      ...
      new MiniCssExtractPlugin({
        ...
        filename: paths.multiPage ? 'static/[name]/[name].[contenthash:8].css' : 'static/css/[name].[contenthash:8].css',
      ...
      !paths.multiPage && new WebpackManifestPlugin({
